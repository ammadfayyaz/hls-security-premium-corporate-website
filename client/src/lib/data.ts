...
export const productCategories = [
  {
    ...
    icon: "bell",
    products: [
      { name: "Control Panels", description: "Intelligent control panels managing all alarm sensors and zones with programmable logic.", image: "/images/products/product-control-panels-hls.webp", features: ["Up to 96 zones", "Wireless & wired support", "Remote programming", "Event logging"], specs: { "Power": "12V DC", "Backup": "7Ah battery", "Zones": "Up to 96", "Connectivity": "WiFi, GSM, IP" } },
      { name: "Motion Detectors", description: "PIR and dual-tech motion sensors with pet immunity and anti-mask technology.", image: "/images/products/product-motion-detectors-hls.webp", features: ["Pet immunity up to 40kg", "Anti-mask detection", "Dual technology", "12m range"], specs: { "Range": "12 meters", "Detection": "PIR + Microwave", "Pet Immunity": "Up to 40kg", "Power": "3V lithium" } },
      { name: "Door Sensors", description: "Magnetic contact sensors for doors and windows with tamper protection.", image: "/images/products/product-door-sensors-hls.webp", features: ["Reed switch technology", "Tamper protection", "Wired or wireless", "Surface or flush mount"], specs: { "Gap": "Up to 50mm", "Type": "Reed switch", "Tamper": "Yes", "Power": "3V or wired" } },
      { name: "Glass Break Sensors", description: "Acoustic glass break detectors recognizing breaking glass patterns across frequencies.", image: "/images/products/product-glass-break-sensors-hls.webp", features: ["6m detection range", "Audio analysis", "Multi-pane detection", "False alarm filtering"], specs: { "Range": "6 meters", "Detection": "Acoustic", "Frequencies": "Low + High", "Power": "3V lithium" } },
      { name: "Smoke Sensors", description: "Advanced smoke sensors identify the early presence of smoke and provide rapid warning of potential fire incidents, integrating seamlessly with the security alarm system.", image: "/images/products/product-smoke-sensors-hls.webp", features: ["Early smoke detection", "High-sensitivity photoelectric sensing", "Audible local alarm", "24/7 monitoring compatibility"], specs: { "Detection": "Photoelectric smoke detection", "Alarm": "Audible local alarm", "Power": "Battery operated", "Monitoring": "Wired or wireless integration" } },
      { name: "Heat Detector", description: "Reliable heat detection for areas where smoke sensors may be unsuitable, identifying abnormal temperature conditions and triggering an alarm during a potential fire event.", image: "/images/products/product-heat-detector-hls.webp", features: ["Rapid heat detection", "Fixed-temperature detection", "Reliable operation in challenging environments", "Integration with alarm control panels"], specs: { "Detection": "Heat / temperature sensing", "Detection Type": "Rate-of-rise", "Power": "Low-voltage or battery operated", "Integration": "Wired or wireless alarm systems" } },
      { name: "Gas Leak Detector", description: "Gas leak sensors detect the presence of hazardous combustible gases and provide early warning to help protect people, property, and critical areas.", image: "/images/products/product-gas-leak-detector-hls.webp", features: ["Rapid gas leak detection", "High-sensitivity gas sensing", "Audible and alarm-system notification", "Continuous 24/7 monitoring"], specs: { "Detection": "Combustible gas", "Sensor Type": "Gas sensing element", "Alarm": "Audible and alarm-system alert", "Installation": "Wall-mounted" } },
      { name: "Water Leak Sensor", description: "Water leak sensors identify unwanted water accumulation or leakage and provide early warning before water damage can escalate.", image: "/images/products/product-water-leak-sensor-hls.webp", features: ["Early water leak detection", "High-sensitivity water sensing", "24/7 monitoring", "Wired or wireless alarm integration"], specs: { "Detection": "Water / moisture", "Sensor Type": "Water contact detection", "Monitoring": "Continuous", "Integration": "Security alarm system" } },
      { name: "Sirens", description: "High-output indoor and outdoor sirens with strobe lights for visual deterrence.", image: "/images/products/product-sirens-hls.webp", features: ["118dB output", "Strobe light", "Tamper protected", "Weather resistant"], specs: { "Output": "118dB", "Strobe": "Yes", "Tamper": "Yes", "Rating": "IP54" } },
